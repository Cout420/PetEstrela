...
export const memorialPets = [
  {
    ...
    images: [
      PlaceHolderImages.find((img) => img.id === 'pet-bento'),
      PlaceHolderImages.find((img) => img.id === 'pet-luna'),
      PlaceHolderImages.find((img) => img.id === 'pet-max'),
      PlaceHolderImages.find((img) => img.id === 'pet-mimi'),
      PlaceHolderImages.find((img) => img.id === 'hero-garden'),
    ]
  },
  {
    id: 2,
