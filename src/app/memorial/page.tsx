  ...
  return (
    <>
      <section className="relative flex h-[70vh] items-center justify-center text-center text-white">
        <Image
          src="https://images.unsplash.com/photo-1448375240586-882707db888b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw3fHxncmVlbiUyMGZvcmVzdHxlbnwwfHx8fDE3NTg5MTM3MTB8MA&ixlib=rb-4.1.0&q=80&w=1080"
